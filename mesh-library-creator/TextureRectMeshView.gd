...
# Members
##############################################################################
#var m_logger = LogStream.new("Texture Rect MeshView", LogStream.LogLevel.DEBUG)
var m_logger = LogStream.new("Texture Rect MeshView", LogStream.LogLevel.INFO)
